...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["date_time"]) && !empty($_POST["date_time"])) {
      ...
      $stmt=$conn->prepare("DELETE FROM tasks_TB WHERE Date_Time < ?");
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <li><a href="robotpanel.php">Robot</a></li>
        ...
        <li class="active"><a href="deleteall.php">Delete Task</a></li>
      </ul>
...
<div class="container-fluid text-center"  style="padding-top: 50px;" >
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
      <h2>Remove Task</h2>
<hr>
      <form id="deleteform" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" class="form-horizontal" style="padding-top: 50px;">

        <div class="form-group">
          <label class="control-label col-sm-4" for="pwd">Delete all task before </label>
          <div class="col-sm-6">
            <div class='input-group date' id='datetimepicker1'>
              <span class="input-group-addon">
                  <span class="glyphicon glyphicon-calendar"></span>
              </span>
                   <input name="date_time" type='text' class="form-control" placeholder="YYYY-MM-DD h:m A"/>
