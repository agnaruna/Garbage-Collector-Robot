...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_GET['page']) && !empty($_GET['page'])) {
       $offset=10*($_GET['page']);
         ...
         $sql="select roundid,path_name,Date_Time,RB_status,robotID  from tasks_TB where RB_status='not yet' order by Date_Time DESC limit ".$offset." , 10";
  ...
  if ($sql==null) {
      $sql="select roundid,path_name,Date_Time,RB_status,robotID  from tasks_TB where RB_status='not yet' order by Date_Time DESC limit 10";
  }
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <ul class="dropdown-menu">
        ...
        <li class="active"><a href="notyet.php">Not Yet</a></li>
