...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_POST['rowid']) && !empty($_POST['rowid'])) {
    ...
    if (isset($_GET['page']) && !empty($_GET['page'])) {
       $offset=10*($_GET['page']);
      $sql="select roundid,path_name,Date_Time,RB_status,robotID  from tasks_TB order by Date_Time DESC limit ".$offset." , 10";
  ...
  if ($sql==null) {
      $sql="select roundid,path_name,Date_Time,RB_status,robotID  from tasks_TB order by Date_Time DESC limit 10";
  }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="homepanel.php">Home</a></li>
        <li class="dropdown">
