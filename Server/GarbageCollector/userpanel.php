...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["user"]) && !empty($_POST["user"])) {
      ...
      $stmt=$conn->prepare("insert into rclogin values (?,?)");

      $stmt->bind_param("ss",$user,$Password);

      $stmt->execute();
      echo "<script type='text/javascript'>alert('User has been added..!');</script>";
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <ul class="dropdown-menu">
         ...
         <li class="active"><a href="userpanel.php">Add User</a></li>
       </ul>
     </li>
      ...
      <form id="eventForm" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" class="form-horizontal" style="padding-top: 50px;">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            ...
            <input type="password" name="pass" class="form-control" id="pwd" placeholder="Enter password" required="true">
          </div>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-default"> <span class="glyphicon glyphicon-ok"></span> Add User</button>
          </div>
        </div>
